...
| `config.labelMap`        | Mapping of labels from a record, reusing default ones. See [Fluent Bit documentation](../../../cmd/fluent-bit/README.md) |                                  |
| `config.customLabelMap`  | Mapping of labels from a record, ignoring default ones. See [Fluent Bit documentation](../../../cmd/fluent-bit/README.md) |                                  |
...
| `config.extraTailConfig` | A set of configuration to append to the existing tail config. See [Official Fluent Bit documentation](https://docs.fluentbit.io/manual/pipeline/inputs/tail#config).                               | `[]`                            |
